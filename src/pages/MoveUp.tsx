    ...
    <div className="w-full text-slate-100 py-2 sm:py-4">
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          <div className="p-2.5 sm:p-3 bg-indigo-600 rounded-2xl text-white shadow-lg shrink-0">
            <LibraryBig className="w-6 h-6 sm:w-7 sm:h-7" />
          </div>
          <div>
            <h1 className="text-xl sm:text-2xl font-black text-white tracking-wide">MOVE UP</h1>
            <p className="text-[11px] sm:text-xs text-indigo-400 font-semibold uppercase tracking-wider">
